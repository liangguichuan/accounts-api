...
public class UserController {
    ...
    @PostMapping("/login")
    public BusinessResult<UserVO> login(@RequestBody LoginVO loginVO){
        return BusinessResult.success(userService.login(loginVO.getEmail(), loginVO.getPassword()));
    }
    ...
    @PostMapping("/logon")
    public BusinessResult<Boolean> logon(@Valid @RequestBody LogonVO logonVO){
        return BusinessResult.success(userService.logon(logonVO));
    }
